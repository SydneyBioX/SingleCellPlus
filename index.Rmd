...
If you could not run the last line of the above instructions (`devtools::install_github("SydneyBioX/scdney")`), then please 

1. Try to install gfortran: https://cran.r-project.org/bin/macosx/tools/
...
install.packages("https://github.com/SydneyBioX/scdney/releases/download/V0.1.3/scdney_0.1.3.tgz", repos = NULL)
```
