...
For the purpose of demonstration, we would like to highlight the effect of similarity metric to your cluster output. We will first compute a t-SNE plot and then overlay that with 
  ...
  + True cell type labels from the publication
...
**[Optional]** We can evaluate the clustering performance using the cell type labels providede from the publication. 
...
**NOTE:** From this step, we will assume we have correctly refined our cell type information from above steps and we will use the cell type information provided in the Su et. al. 2017 publication.
